...
class Com_jeecardInstallerScript
{
    ...
    private function installationResults($status)
    {
        ...
        $language->load('com_jeecard');
        $rows = 0; ?>
        
        <h2><?php echo JText::_('JE Ecard Install Successfully'); ?></h2>
        <table class="adminlist table table-striped">
            ...
            <tbody>
                <tr class="row0">
                    <td class="key" colspan="2"><?php echo 'JE '.JText::_('Ecard Component'); ?></td>
    ...
    $rows = 0;
 ?>
        <h2><?php echo JText::_('JE Ecard Removed Successfully'); ?></h2>
        <table class="adminlist table table-striped">
            <thead>
                <tr>
                    <th class="title" colspan="2"><?php echo JText::_('Component'); ?></th>
