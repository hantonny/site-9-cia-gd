...
class eventinviteVieweventinvite extends JViewLegacy 
{
	...
	{	
		...
		$document->setTitle( JText::_('EVENT_INVITATION') );
   		 
   		JToolBarHelper::title(   JText::_( 'EVENT_INVITATION_MANAGEMENT') );   		
		...
		$plan = $mainframe->getUserStateFromRequest( $context.'eventinvite','eventinvite',0 );
	 	$lists['order'] 		= $filter_order;  
		$lists['order_Dir'] = $filter_order_Dir;
		
		$eventinvite			= $this->get( 'Data');
...
/*		$allevent	= $this->get('allevent');
		...
		$this->assignRef('searchlists',		$searchlists);    
  		$this->assignRef('eventinvite',		$eventinvite); 		
