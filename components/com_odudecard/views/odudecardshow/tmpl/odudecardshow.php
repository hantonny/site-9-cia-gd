...
include ( JPATH_BASE .DS.'components'.DS.'com_odudecard'.DS.'template'.DS.$temp.DS.$temp.'.tpl.php' );
	...
	if($setting->share==1)
   {
	...
	include ( JPATH_BASE .DS.'components'.DS.'com_odudecard'.DS.'template'.DS.$temp.DS.$temp.'.navigation.tpl.php' );
?>
<?php
//Hit Counter
if (!session_id())
...
?>
        ...
        <input type="submit" name="button2" id="button2" value="<?php echo JText::_('COM_ODUDECARD_ECARD_SEND_ECARD_FIRST'); ?>" class="pure-button pure-button-primary" />
