...
if($params->get( 'show_postedby')=='1')
{
 ...
 echo JText::_('COM_ODUDECARD_POSTED_BY'); ?>  :<a href='<?php echo JRoute::_('index.php?option=com_odudecard&controller=odudecardmylist&Itemid='.$mymenuitem.'&id='.$this->username); ?>' > <?php echo $this->username; ?> </a>
