...
<div class="box"> 
  <form id='myForm' action="<?php echo JRoute::_("index.php?option=com_odudecard&amp;controller=cardsend&amp;Itemid=$mymenuitem");?>" method="post" class="form-validate" onSubmit="return myValidate(this);"> 
  <input name="id" type="hidden" id="id" value="<?php echo $iid;  ?>" />      
   <input name="cate" type="hidden" id="cate" value="<?php echo $this->cate;  ?>" />  
    ...
    <fieldset class="pure-group">
        <input type="text" name="SN" id="SN" class="pure-input-1 required" placeholder="<?php echo JText::_('COM_ODUDECARD_ECARD_YOUR_NAME'); ?>" value="<?php echo $SN;  ?>">
        <input type="email" name="SE" id="SE" class="pure-input-1 required validate-email"  placeholder=" <?php echo JText::_('COM_ODUDECARD_ECARD_YOUR_EMAIL'); ?>" value="<?php echo $SE;  ?>">
        <input type="text" name="title" id="title" class="pure-input-1 required" placeholder="<?php echo JText::_('COM_ODUDECARD_ECARD_SUBJECT'); ?>" value="<?php echo $sub;  ?>">
    </fieldset>
