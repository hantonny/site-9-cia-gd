...
<?php
 if(  $params->get( 'show_video' )=='1')
    {
 ?>   
  <a href="<?php echo JRoute::_('index.php?option=com_odudecard&controller=create_video&Itemid='.$mymenuitem.'&cate='.$q_cate.'&opt='.$opt); ?>" class="pure-button pure-button-primary"><?php echo JText::_('COM_ODUDECARD_ECARD_CREATE_VIDEO'); ?></a>&nbsp;
